...
async function seed() {
  ...
  const answersData = [
    ...
    { answer: 'Alcohol.', correct: true, questionId: 5 },
    { answer: 'Mechanical problems.', correct: false, questionId: 5 },
    { answer: 'Bad weather conditions.', correct: false, questionId: 5 },
    { answer: 'Bad road conditions.', correct: false, questionId: 5 },
    {
      answer:
